<?php
/**
 * application/models/ion_auth_mongodb_model.php
 *
 * @package default
 */
...
class Ion_auth_mongodb_model extends CI_Model {
     ...
     * @param unknown $use_sha1_override (optional)
     * @return unknown
     */
     ...
     *
     * @param unknown $identity (optional)
     * @return bool
     */
     ...
     * @param unknown $identity
     * @param unknown $password
     * @param unknown $remember (optional)
     * @return bool
     */
     ...
     *
     * @param unknown $identity
     * @param unknown $expire_period (optional)
     * @return unknown
     */
     ...
     * @author Ben Edmunds
     * @param unknown $group_name        (optional)
     * @param unknown $group_description (optional)
     * @param unknown $additional_data   (optional)
     * @return unknown
     */
     ...
     *
     * @param unknown $start_delimiter
     * @param unknown $end_delimiter
     * @return bool
     */
     ...
     *
     * @param unknown $langify (optional)
     * @return unknown
     * */
